...
namespace Assets.Scripts.UI
{
    class Cutscene : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            {
                if (Util.CustomInput.BoolFreshPress(Util.CustomInput.UserInput.Accept) || Util.CustomInput.BoolFreshPress(Util.CustomInput.UserInput.Attack) || Util.CustomInput.BoolFreshPress(Util.CustomInput.UserInput.Pause))
                {
                    currentLetter = 0;
                    currentPage++;
